  ...
  <section class="w-full pb-20">
    <div class="mx-auto max-w-7xl px-6 md:px-12 xl:px-6">
      <div class="mx-auto mt-6 text-center">
        <h1 class="py-8 text-4xl font-extrabold text-zinc-900 md:text-5xl">
          Plan Your Visit
        </h1>

        <p class="mx-auto max-w-3xl text-lg leading-7 text-zinc-700">
          Welcome! We’re so glad you’re considering visiting our church. Our
          goal is to make your experience as smooth and spiritually uplifting as
          possible. We’ve gathered answers to common questions below. If you
          don’t find what you need, <a
            href="/plan-your-visit#form"
            class="underline decoration-sky-400 underline-offset-2"
            >reach out with the form</a
        ...
        {#each faqs as { question, answer, icon }}
          ...
          >
            <div class="flex justify-evenly items-center gap-4">
              ...
              <h3 class="text-lg font-semibold text-zinc-900 grow">
                {question}
              </h3>
            </div>
  ...
  <section id="form" class="w-full pt-12">
    <div class="mx-auto max-w-7xl px-6 md:px-12 xl:px-6 pb-20">
      <div class="mt-20 text-center">
        <h2 class="text-3xl font-bold text-zinc-900 md:text-4xl">
          Reach Out Directly
        </h2>
        <p class="mx-auto mt-6 max-w-2xl text-lg text-zinc-700">
          Visiting a new church can feel intimidating, but we’re here to help
          you feel at home. Use the form below to ask us anything!
        </p>
      </div>
      ...
      >
        ...
        >
          <input
            type="hidden"
            name="subject"
            value="New Submission from EBC Contact Form"
          />
          ...
          <!-- Message -->
          <Label for="message" class="mb-2 capitalize text-zinc-900"
         ...
         focus-within:border-sky-400 focus-within:ring-2 focus-within:ring-sky-300"
          >
           ...
           focus:outline-none focus:ring-0"
            ...
            <div
              id="message-help"
              class="border-t bg-zinc-50 px-4 py-2 text-sm text-zinc-600"
            >
